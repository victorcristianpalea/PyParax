# -*- coding: utf-8 -*-
"""
Created on Wed Jul  8 02:03:29 2020
...
def dual_system_mask_computation_2():
    ...
    #Check the beam profile propagation through the optical system
    system = system1 + [['mp', mask, 0,0]] + system2
    f = parax.experimental_simulator.experimental_simulator_2d.propagate(f_in, system, output_full = True, forward = True, print_output=True)
